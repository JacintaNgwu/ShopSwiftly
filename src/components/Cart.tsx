  ...
  return (
    ...
    >
        ...
        >
            ...
            <button className="bg-accent text-white-center w-full rounded-3xl py-2 hover:bg-accentdark mb-2 mt-4">View Cart</button>
            <button className="bg-accent text-white-center w-full rounded-3xl py-2 hover:bg-accentdark">Chekout</button>
        </div>
    </div>
  )
}
